...
#Q.18 What is SVG?
##Ans:
SVG is Scalable Vector Graphics, SVG is used to define graphics for the Web.
...
##Ans:
In HTML the formatting tags are divided into two categories: Physical tag: These tags are used to provide the visual appearance to the text. Logical tag: These tags are used to add some logical or semantic value to the text.
